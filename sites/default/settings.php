...
$envToDrupalMap = array(
    ...
    'strings' => array(
        ...
        'error_level' => 'CMP_DRUPAL_ERROR_LEVEL', /* 0=none, 1=error,warning, 2=all */
        ...
        /* Drupal variables, strings, used by the usa_tax_man module */
        'utm_tax_menusource'        => 'CMP_DRUPAL_UTM_TAX_MENUSOURCE',
        'utm_tax_menudest'          => 'CMP_DRUPAL_UTM_TAX_MENUDEST',
        'utm_tax_menulimit'         => 'CMP_DRUPAL_UTM_TAX_MENULIMIT',
        'utm_menu_targets'          => 'CMP_DRUPAL_UTM_MENU_TARGETS',
        'utm_check_menu_titles'     => 'CMP_DRUPAL_UTM_CHECK_MENU_TITLES',
        'utm_menu_targ_rep_replace' => 'CMP_DRUPAL_UTM_MENU_TARG_REP_REPLACE',
        'utm_menu_targ_rep_find'    => 'CMP_DRUPAL_UTM_MENU_TARG_REP_FIND',
        'utm_field_dependant_value' => 'CMP_DRUPAL_UTM_FIELD_DEPENDANT_VALUE',
        'utm_field_dependant_field' => 'CMP_DRUPAL_UTM_FIELD_DEPENDANT_FIELD',
        'utm_full_link_dep_field'   => 'CMP_DRUPAL_UTM_FULL_LINK_DEP_FIELD',
        'utm_full_link_dep_value'   => 'CMP_DRUPAL_UTM_FULL_LINK_DEP_VALUE',
        ...
        /* Drupal variables, strings, used by the akamai module */
        'akamai_username' => 'CMP_DRUPAL_AKAMAI_USERNAME',
        'akamai_password' => 'CMP_DRUPAL_AKAMAI_PASSWORD',
        'akamai_restapi'  => 'CMP_DRUPAL_AKAMAI_RESTAPI',
        'akamai_domain'   => 'CMP_DRUPAL_AKAMAI_DOMAIN',
        'akamai_basepath' => 'CMP_DRUPAL_AKAMAI_BASEPATH',
        'akamai_cpcode'   => 'CMP_DRUPAL_AKAMAI_CPCODE',

        /* Drupal variables, strings, used by elasticsearch module */
        ...
        /* usasearch module */
        'usasearch_affiliate_name' => 'CMP_DRUPAL_USASEARCH_AFFILIATE_NAME',
        'usasearch_drawer_handle'  => 'CMP_DRUPAL_USASEARCH_DRAWER_HANDLE',
        'usasearch_api_password'   => 'CMP_DRUPAL_USASEARCH_API_PASSWORD',
    ...
    'integers' => array(
        ...
        /* Drupal variables, integers, used by the usa_tax_man module */
        'utm_create_menus'       => 'CMP_DRUPAL_UTM_CREATE_MENUS',
        'utm_menu_targ_replace'  => 'CMP_DRUPAL_UTM_MENU_TARG_REPLACE',
        'utm_root_tax_menu'      => 'CMP_DRUPAL_UTM_ROOT_TAX_MENU',
        'utm_check_menu_on_init' => 'CMP_DRUPAL_UTM_CHECK_MENU_ON_INIT',
        'utm_field_dependant'    => 'CMP_DRUPAL_UTM_FIELD_DEPENDANT',
        'utm_full_link_dep'      => 'CMP_DRUPAL_UTM_FULL_LINK_DEP',
...
if (getenv('CMP_DRUPAL_DB_NAME') === false) {
    @ob_end_clean();
    @ob_end_clean();
    @ob_end_clean();
    print "You must set environmental variables like CMP_DRUPAL_DB_NAME "
    ."for settings.php to pick up for this child site to run appropriately.";
    exit();
}
