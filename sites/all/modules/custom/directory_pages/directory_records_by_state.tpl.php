  ...
  <article>
    ...
    <?php if(@!empty($dirRecords['SGA'][0]->field_phone_number['und'][0]['value'])): ?>
      <section itemscope="" itemtype="http://microformats.org/wiki/hCard" class="<?php echo (($agencyCounter++) % 2 == 0) ? 'otlnrw' : 'otln' ?>">
        ...
        <p class="spk tel"><?php print $dirRecords['SGA'][0]->field_phone_number['und'][0]['value']; ?></p>
      </section>
    <?php endif; ?>
    <?php if(@!empty($dirRecords['SGA'][0]->field_toll_free_number['und'][0]['value'])): ?>
      <section itemscope="" itemtype="http://microformats.org/wiki/hCard" class="<?php echo (($agencyCounter++) % 2 == 0) ? 'otlnrw' : 'otln' ?>">
        ...
        <p class="spk tel"><?php print $dirRecords['SGA'][0]->field_toll_free_number['und'][0]['value']; ?></p>
      </section>
    <?php endif; ?>
    <?php if(@!empty($dirRecords['SGA'][0]->field_tty_number['und'][0]['value'])): ?>
      <section itemscope="" itemtype="http://microformats.org/wiki/hCard" class="<?php echo (($agencyCounter++) % 2 == 0) ? 'otlnrw' : 'otln' ?>">
        ...
        <p class="spk tel"><?php print $dirRecords['SGA'][0]->field_tty_number['und'][0]['value']; ?></p>
      </section>
    <?php endif; ?>
    ...
    <?php $agencyCounter2 = 1; ?>
      ...
      <?php if(@!empty($dirRecords['DMV'][0]->field_phone_number['und'][0]['value'])): ?>
        <section itemscope="" itemtype="http://microformats.org/wiki/hCard" class="<?php echo (($agencyCounter2++) % 2 == 0) ? 'otlnrw' : 'otln' ?>">
          ...
          <p class="spk tel"><?php print $dirRecords['DMV'][0]->field_phone_number['und'][0]['value']; ?></p>
        </section>
      <?php endif; ?>
      <?php if(@!empty($dirRecords['DMV'][0]->field_toll_free_number['und'][0]['value'])): ?>
        <section itemscope="" itemtype="http://microformats.org/wiki/hCard" class="<?php echo (($agencyCounter2++) % 2 == 0) ? 'otlnrw' : 'otln' ?>">
          ...
          <p class="spk tel"><?php print $dirRecords['DMV'][0]->field_toll_free_number['und'][0]['value']; ?></p>
        </section>
      <?php endif; ?>
      <?php if(@!empty($dirRecords['DMV'][0]->field_tty_number['und'][0]['value'])): ?>
        <section itemscope="" itemtype="http://microformats.org/wiki/hCard" class="<?php echo (($agencyCounter2++) % 2 == 0) ? 'otlnrw' : 'otln' ?>">
          ...
          <p class="spk tel"><?php print $dirRecords['DMV'][0]->field_tty_number['und'][0]['value']; ?></p>
        </section>
      <?php endif; ?>
    <p class="volver clearfix"><a href="#skiptarget"><span class="icon-backtotop-dwnlvl">Back to Top</span></a></p>
  <?php endif; ?>
