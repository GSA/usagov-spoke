 ...
 */
function mars_form_system_theme_settings_alter(&$form, &$form_state, $form_id = NULL)  {
  ...
  $form['custom']['mars_layout'] = array(
    '#type'          => 'radios',
    '#title'         => t('Layout'),
    '#options'       => array(0 => t('Single column'),
                              1 => t('Right sidebar'),
                              2 => t('Left sidebar')),
    '#default_value' => theme_get_setting('mars_layout'),
  );
  $form['custom']['mars_max_width'] = array(
    '#type'          => 'textfield',
    '#title'         => t('Max width'),
    '#description'   => t('The maximum width of the site in pixels (px).'),
    '#default_value' => theme_get_setting('mars_max_width'),
    '#size'          => 5,
    '#maxlength'     => 10,
  );
  $form['custom']['mars_display_main_menu'] = array(
    '#type'          => 'checkbox',
    '#title'         => t("Display Drupal's default main menu"),
    '#default_value' => theme_get_setting('mars_display_main_menu'),
