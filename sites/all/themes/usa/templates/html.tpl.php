...
<head>
    ...
    <meta property="og:image"         content="https://<?php print strtolower($domain . base_path() . htmlspecialchars(rtrim(request_path(),'/'), ENT_QUOTES, "UTF-8")); ?>/sites/all/themes/usa/images/<?php print $fb_img; ?>" />
