(function(){
	...
	function youtube(ob){
	 ...
	 function loadvideo(HTMLid,videoId){
		var videowrapper = document.getElementById(HTMLid);
		if(!videowrapper){throw new Error("No HTML element with id '" + HTMLid + "'"); return;}
		if(videowrapper.nodeName.toLowerCase() == "iframe"){
		...
		videowrapper.loadOtherVersion(videoId);
	}
