...
jQuery(function(){
  ...
  if(jQuery('#emergency').length!=0){
    ...
    switch (getAllUrlParams().source) {
      case "busa":
        var title="Welcome to USAgov"
        var button="Continue to Small Business"
        
        var content=[
          "<p>The website BusinessUSA has been discontinued. Instead, you have been redirected to the small business section of USAgov.</p>",
          "<p>Here, you can continue your search for officil government information that can help your business grow.</p>"
        ].join("\n");
      ...
      case "kids":
        var title="Welcome to USAgov"
        var button="Continue to Education"
...
function showModal(id, title, content, button) {
  ...
  if(cookieID) {
    ...
    var modal = $([
      ...
      "  <div class=\"usa-grid\">",
      "    <div>",
      "      <button class=\"close top\" onclick=\"closeModal()\">",
      "        Close",
      "      </button>",
      "      <div class=\"icon\"></div>",
      "      <h2>"+title+"</h2>",
